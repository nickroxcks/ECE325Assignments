...
public class PlaylistTest extends TestCase {
    ...
    public void test_sortByArtist() {
    	fillPlaylist();
    	aPlaylist.sortArtist();
    	//findSong method returns the index of the song in the playlist
    	//if sorting worked, should be ordered song1,song2,song3,.....
    	assertEquals(0,aPlaylist.findSong(song1));
    	assertEquals(1,aPlaylist.findSong(song2));
    	assertEquals(2,aPlaylist.findSong(song3));
    	assertEquals(3,aPlaylist.findSong(song4));
    ...
    public void test_sortByTitle() {
    	...
    	aPlaylist.sortTitle();
    	//findSong method returns the index of the song in the playlist
    	//if sorting worked, should be ordered song1,song3,song2,song4.....
    	assertEquals(0,aPlaylist.findSong(song1));
    	assertEquals(1,aPlaylist.findSong(song3));
    	assertEquals(2,aPlaylist.findSong(song2));
    	assertEquals(3,aPlaylist.findSong(song4));
