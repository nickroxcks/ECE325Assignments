...
public class SolveQuadraticTests {
    ...
    @Test public void testSingleRoot() {
        ...
        Double[] roots = calc.getRoots(a, b, c);
        assertEquals(roots.length,2); // this value before was 1. I believe this was meant to be 2,
        double x = roots[0].doubleValue();//otherwise testRandomNon wouldn't work for array size 2.
        assertTrue(Math.abs(a * x * x + b * x + c) < epsilon);// Assignment description is very unclear. 
    }
